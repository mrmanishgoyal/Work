...
public class payLoad_NeoClasses{
	
	public static Logger log = LogManager.getLogger(payLoad_NeoClasses.class.getName());
	...
	static long Premiumid= 52512498345L+randomNum;
	...
	public static String bodycontent() {
		...
		String bodycontent="{\r\n"
				...
				+ "    {\r\n"
				+ "      \"method\": \"PATCH\",\r\n"
				+ "      \"url\": \"/services/data/v48.0/sobjects/Student_Program__c/Student_Enrolment_ID__c/STUPR0108812"+randomNum+"23\",\r\n"
	...
	//***************************************************************************************************
	//Student School Informations payload
	
	public static String StudentSchoolInformations() {
		System.out.println("The value of Premium id entering is:"+Premiumid);
		String SSI="{\r\n"
				+ "  \"allOrNone\": true,\r\n"
				+ "  \"compositeRequest\": [\r\n"
				...
				+ "        {\r\n"
				+ "            \"method\": \"PATCH\",\r\n"
				+ "            \"url\": \"/services/data/v53.0/composite/sobjects/School_Information__c/School_Identifier__c\",\r\n"
				+ "            \"referenceId\": \"schoolRef\",\r\n"
				+ "            \"body\": {\r\n"
				+ "                \"allOrNone\": true,\r\n"
				+ "                \"records\": [\r\n"
				+ "                    {\r\n"
				+ "                        \"attributes\": {\r\n"
				+ "                        \"type\": \"School_Information__c\",\r\n"
				+ "                        \"referenceId\": \"schoolInfo1\"\r\n"
				+ "                        },\r\n"
				+ "                        \"School_Name__c\": \"Test"+Premiumid+"\",\r\n"
				+ "                        \"School_Address__c\": \"\",\r\n"
				+ "                        \"City__c\": \"\",\r\n"
				+ "                        \"State__c\": \"\",\r\n"
				+ "                        \"Country__c\": \"\",\r\n"
				+ "                        \"Pincode__c\": \"\",\r\n"
				+ "                        \"School_Identifier__c\" : \"Test"+Premiumid+"\"\r\n"
				+ "                    }\r\n"
				+ "                ]\r\n"
				+ "            }\r\n"
				+ "        },\r\n"
				+ "        {\r\n"
				+ "            \"method\": \"PATCH\",\r\n"
				+ "            \"url\": \"/services/data/v53.0/composite/sobjects/Student_School_Information__c/Student_School_Information__c\",\r\n"
				+ "            \"referenceId\": \"studentSchoolInfoList\",\r\n"
				+ "            \"body\": {\r\n"
				+ "                \"allOrNone\": true,\r\n"
				+ "                \"records\": [\r\n"
				+ "                    {\r\n"
				+ "                        \"attributes\": {\r\n"
				+ "                        \"type\": \"Student_School_Information__c\",\r\n"
				+ "                        \"referenceId\": \"schoolStudentInfo\"\r\n"
				+ "                        },\r\n"
				+ "                        \"Student__c\": \"@{accountRef.records[0].Id}\",\r\n"
				+ "                        \"School_Information__c\": \"@{schoolRef[0].id}\",\r\n"
				+ "                        \"Student_School_Information__c\": \"@{schoolRef[0].id}-@{accountRef.records[0].Id}\"\r\n"
				+ "                    }\r\n"
				+ "                ]\r\n"
				+ "            }\r\n"
				+ "        }\r\n"
	...
	public static String StudentSchoolInformations_UAT() {
		String val = "OAuth ";
		String SSI="";
		SSI = given().header("Authorization", val + Utils.Access_Token())
				.header("Content-Type", "application/json").body(StudentSchoolInformations()).when()
				.post("https://byjusprod--byjusuat.my.salesforce.com/services/data/v53.0/composite").then().log().all()
				.extract().response().asString();
        log.info("The response is: "+SSI);
		return SSI;

	}
	
	public static String StudentSchoolInformations_UATFC() {
		String val = "OAuth ";
		String SSI="";
		SSI = given().header("Authorization", val + Utils.Access_TokenUATFC())
				.header("Content-Type", "application/json").body(StudentSchoolInformations()).when()
				.post("https://byjusprod--byjusuatfc.my.salesforce.com/services/data/v53.0/composite").then().log().all()
				.extract().response().asString();
        log.info("The response is: "+SSI);
	...
	public static String StudentSchoolInformations_Prod() {
		String val = "OAuth ";
		String SSI="";
		SSI = given().header("Authorization", val + Utils.Access_TokenProd())
				.header("Content-Type", "application/json").body(StudentSchoolInformations()).when()
				.post("https://byjusprod.my.salesforce.com/services/data/v53.0/composite").then().log().all()
				.extract().response().asString();
        log.info("The response is: "+SSI);
	...
	public static String StudentSchoolInformationsResponse_UAT() {

		String id="";
		JsonPath js1 = new JsonPath(StudentSchoolInformations_UAT());
		id = js1.get("compositeResponse[1].body[0].id");
		System.out.println("The value of School Information id is: " + id);
		return id;

	}
	
	public static String StudentSchoolInformationsResponse_UATFC() {

		String id="";
		JsonPath js1 = new JsonPath(StudentSchoolInformations_UATFC());
		id = js1.get("compositeResponse[1].body[0].id");
		System.out.println("The value of School Information id is: " + id);
		return id;
	...
	public static String StudentSchoolInformationsResponse_Prod() {

		String id="";
		JsonPath js1 = new JsonPath(StudentSchoolInformations_Prod());
		id = js1.get("compositeResponse[1].body[0].id");
		System.out.println("The value of School Information id is: " + id);
		return id;
