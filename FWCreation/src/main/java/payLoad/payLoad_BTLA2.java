...
public class payLoad_BTLA2{
	
	public static Logger log = LogManager.getLogger(payLoad_BTLA2.class.getName());
	...
	static long Premiumid= 52502495345L+randomNum;
	static int counter1=1;
	
	public static String bodycontent() {
		//Add "+Premiumid+""+counter1+" to Premium Id and "+randomNum+" to Student Enrollment Id
		...
		String bodycontent="{\r\n"
				...
				+ "    {\r\n"
				+ "      \"method\": \"PATCH\",\r\n"
				+ "      \"url\": \"/services/data/v48.0/sobjects/Account/Premium_ID__c/"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"referenceId\": \"RefStudent"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"body\": {\r\n"
				...
				+ "    {\r\n"
				+ "      \"method\": \"PATCH\",\r\n"
				+ "      \"url\": \"/services/data/v48.0/sobjects/Student_Sales_Order__c/Sales_Order_No__c/SSORD"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"referenceId\": \"RefSSORD"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"body\": {\r\n"
				...
				+ "              \"referenceId\": \"order1\"\r\n"
				+ "            },\r\n"
				+ "            \"Order_No__c\": \"ORD1"+Premiumid+""+counter1+"\",\r\n"
				+ "            \"Name\": \"Order : K12 course-1st Order\",\r\n"
				+ "            \"Course_Name__c\": \"9th Physics\",\r\n"
				+ "            \"Order_Start_Date__c\": \"2022-03-11\",\r\n"
				+ "            \"Board__c\": \"ICSE\",\r\n"
				...
				+ "              \"Sales_Order_No__c\": \"SSORD"+Premiumid+""+counter1+"\"\r\n"
				+ "            }\r\n"
				+ "          },\r\n"
				+ "          {\r\n"
				+ "            \"attributes\": {\r\n"
				...
				+ "              \"referenceId\": \"order2\"\r\n"
				+ "            },\r\n"
				+ "            \"Order_No__c\": \"ORD2"+Premiumid+""+counter1+"\",\r\n"
				...
				+ "            },\r\n"
				+ "            \"Payment_Reference_ID__c\": \"PD1"+Premiumid+""+counter1+"\",\r\n"
				...
				+ "            },\r\n"
				+ "            \"Payment_Reference_ID__c\": \"PD2"+Premiumid+""+counter1+"\",\r\n"
				...
				+ "            \"Loan_Reference_Id__c\": \"9"+Premiumid+""+counter1+"\",\r\n"
				+ "            \"Order__r\": {\r\n"
				+ "              \"Order_No__c\": \"ORD2"+Premiumid+""+counter1+"\"\r\n"
				+ "            },\r\n"
				+ "            \"Student_Sales_Order__r\": {\r\n"
				...
				+ "    {\r\n"
				+ "      \"method\": \"PATCH\",\r\n"
				+ "      \"url\": \"/services/data/v48.0/sobjects/Student_Program__c/Student_Enrolment_ID__c/STUPRGM"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"referenceId\": \"STUPRGM"+randomNum+"\",\r\n"
				+ "      \"body\": {\r\n"
				+ "        \"Student_Sales_Order__c\": \"@{RefSSORD"+Premiumid+""+counter1+".id}\",\r\n"
				+ "        \"Order__c\": \"@{orderList[1].id}\",\r\n"
				+ "        \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\",\r\n"
				+ "        \"Program__r\": {\r\n"
				...
				+ "            },\r\n"
				+ "            \"Name\": \"Student Order : 1"+Premiumid+""+counter1+"\",\r\n"
				...
				+ "            },\r\n"
				+ "            \"Name\": \"Student Order : 2"+Premiumid+""+counter1+"\",\r\n"
				+ "            \"Order__c\": \"@{orderList[1].id}\",\r\n"
				+ "            \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\"\r\n"
				+ "          }\r\n"
				+ "        ]\r\n"
				...
				+ "      \"method\": \"PATCH\",\r\n"
				+ "      \"url\": \"/services/data/v48.0/composite/sobjects\",\r\n"
				+ "      \"referenceId\": \"RefPaymentPD1"+Premiumid+""+counter1+"\",\r\n"
				+ "      \"body\": {\r\n"
				+ "        \"allOrNone\": true,\r\n"
				+ "        \"records\": [\r\n"
				+ "          {\r\n"
	...
	public static String bodycontent_Prod() {
		...
		String bodycontent="{\r\n"
				...
				+ "            \"Order__c\": \"@{orderList[0].id}\",\r\n"
				+ "            \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\",\r\n"
				+ "            \"Reference_Id__c\": \"@{orderList[0].id}-@{RefStudent"+Premiumid+""+counter1+".id}\"\r\n"
				+ "          },\r\n"
				+ "          {\r\n"
				+ "            \"attributes\": {\r\n"
				+ "              \"type\": \"Student_Orders__c\",\r\n"
				...
				+ "            \"Order__c\": \"@{orderList[1].id}\",\r\n"
				+ "            \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\",\r\n"
				+ "            \"Reference_Id__c\": \"@{orderList[1].id}-@{RefStudent"+Premiumid+""+counter1+".id}\"\r\n"
				+ "          }\r\n"
				+ "        ]\r\n"
				+ "      }\r\n"
				+ "    },\r\n"
				...
				+ "            \"Payment__c\": \"@{paymentList[0].id}\",\r\n"
				+ "            \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\",\r\n"
				+ "            \"SPayment_Reference_ID__c\": \"@{paymentList[0].id}-@{RefStudent"+Premiumid+""+counter1+".id}\"\r\n"				
				+ "          },\r\n"
				+ "          {\r\n"
				+ "            \"attributes\": {\r\n"
				+ "              \"type\": \"Student_Payment__c\"\r\n"
				...
				+ "            \"Payment__c\": \"@{paymentList[1].id}\",\r\n"
				+ "            \"Student__c\": \"@{RefStudent"+Premiumid+""+counter1+".id}\",\r\n"
				+ "            \"SPayment_Reference_ID__c\": \"@{paymentList[1].id}-@{RefStudent"+Premiumid+""+counter1+".id}\"\r\n"
				+ "          }\r\n"
				+ "        ]\r\n"
				+ "      }\r\n"
				+ "    }\r\n"
