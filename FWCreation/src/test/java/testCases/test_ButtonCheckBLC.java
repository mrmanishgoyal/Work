...
public class test_ButtonCheckBLC extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(test_ButtonCheckBLC.class.getName());
	...
	public void TestButtonBLC() throws Exception {
		...
		Thread.sleep(5000);
		ac.CheckButtonsQAandSM(EnvUAT,"Account_BLC");
		ac.CheckRelatedList(EnvUAT,"Account_BLC");
		}
			...
			driver.get(AccountURL);
			Thread.sleep(5000);
			ac.CheckButtonsQAandSM(EnvUATFC,"Account_BLC");
			ac.CheckRelatedList(EnvUATFC,"Account_BLC");
		}
		else {
			...
			driver.get(AccountURL);
			Thread.sleep(5000);
			ac.CheckButtonsQAandSM(EnvProd,"Account_BLC");
			ac.CheckRelatedList(EnvProd,"Account_BLC");
		}
		...
		if(CurrURL.contains("--byjusuat")&&!CurrURL.contains("--byjusuatfc")) {
		ac.CheckCaseListViewButtons(EnvUAT,"Case_BLC");
		}
		else if(CurrURL.contains("--byjusuatfc")){
			ac.CheckCaseListViewButtons(EnvUATFC,"Case_BLC");
		}
		else {
			ac.CheckCaseListViewButtons(EnvProd,"Case_BLC");
		}
