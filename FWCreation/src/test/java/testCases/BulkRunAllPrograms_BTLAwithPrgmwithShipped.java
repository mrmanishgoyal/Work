...
public class BulkRunAllPrograms_BTLAwithPrgmwithShipped extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(BulkRunAllPrograms_BTLAwithPrgmwithShipped.class.getName());
	...
	public void TestBulkRunAllPrograms_BTLAwithPrgmwithShipped(String Progid,String ShippingRegion) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
	       ...
	       // log.info("The response is: "+StudentCreation);
			...
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmswithShipped", i + 1, 0, Progid);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmswithShipped", i + 1, 1, ShippingRegion);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmswithShipped", i + 1, 2, id);
			i++;
