...
public class BulkRunAllPrograms_SinglePrgmwithShipped extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(BulkRunAllPrograms_SinglePrgmwithShipped.class.getName());
	...
	public void TestBulkRunAllPrograms_SinglePrgmwithShipped(String Progid,String ShippingRegion) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
			...
			StudentCreation = given().header("Authorization", val + Utils.Access_Token())
					.header("Content-Type", "application/json").body(payLoad_AllProgram.SingleProgwithShipped(Progid, ShippingRegion)).when()
			...
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "SingleProgidwithShipped", i + 1, 0, Progid);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "SingleProgidwithShipped", i + 1, 1, ShippingRegion);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "SingleProgidwithShipped", i + 1, 2, id);
			i++;
