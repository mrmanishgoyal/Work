...
public class test_IssueTree_PE2 extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(test_IssueTree_PE2.class.getName());
	...
	public void Test_IT_Tech_LS_Tech2(String Accountid, String Taskid,String PSTCT,String Device,String Category,String SCategory,String PSYIST,String ITIRC,String PSTIR) throws Exception {
		...
		//ac.NavBackToAccount();
		ac.closeTabWindows();
		String TaskURL = CurrURL+Taskid;
		driver.get(CurrURL+Taskid);
		Thread.sleep(5000);
		...
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 0, Accountid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 1, Taskid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 2, PSTCT);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 3, Device);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 4, Category);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 5, SCategory);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 6, PSYIST);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 7, ITIRC);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech_LS_Tech2", i + 1, 8, PSTIR);		
		i++;
