...
public class BulkRun_CreateRRwithCaseCreationAPI extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(BulkRun_CreateRRwithCaseCreationAPI.class.getName());
	...
	public void TestRRCaseCreationwithAPI(String Progid, String ShippedRegion, String Accountid, String Contactid,String Premiumid) throws Exception {
		
		//loginPO lo=new loginPO(driver);
		String val = "OAuth ";
		String StudentCreation = given().header("Authorization", val + Utils.Access_Token())
				.header("Content-Type", "application/json").body(payLoad_CaseCreation.CaseCreationRR(Accountid,Contactid)).when()
