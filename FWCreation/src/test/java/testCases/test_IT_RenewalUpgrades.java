...
public class test_IT_RenewalUpgrades extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(test_IT_RenewalUpgrades.class.getName());
	...
	public void Test_IT_RenewalUpgrades(String Prgm1,String Prgm2,String SR,String CC,String Accid,String Cntctid,String TT,String Tid,String Category,String SCategory,String IssueT,String IssueST,String IssueN,String ITIR,String FU1,String FU2,String FU3,String FU4) throws Exception {
		...
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 0, Prgm1);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 1, Prgm2);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 2, SR);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 3, CC);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 4, Accid);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 5, Cntctid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 6, TT);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 7, Tid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 8, Category);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 9, SCategory);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 10, IssueT);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 11, IssueST);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 12, IssueN);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 13, ITIR);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 14, FU1);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 15, FU2);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 16, FU3);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_RenewalUpgrades", i + 1, 17, FU4);
		i++;
