...
public class BulkRunAllPrograms_2DiffPrograms extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(BulkRunAllPrograms_2DiffPrograms.class.getName());
	...
	public void TestBulkRunAllPrograms_2DiffPrograms(String Progid1, String Progid2,String ShippingRegion,String Class) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
			...
			StudentCreation = given().header("Authorization", val + Utils.Access_Token())
					.header("Content-Type", "application/json").body(payLoad_AllProgram.BTLAwithMultiple2(Progid1,Progid2,ShippingRegion,Class)).when()
			...
			//String val1 = "OAuth ";
			//String StudentCreation="";
			//StudentCreation = given().header("Authorization", val1 + Utils.Access_TokenDev02())
			//		.header("Content-Type", "application/json").body(payLoad_AllProgram.BTLAwithMultiple2(Progid1,Progid2,ShippingRegion,Class)).when()
			...
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "2Progs", i + 1, 0, Progid1);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "2Progs", i + 1, 1, Progid2);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "2Progs", i + 1, 2, ShippingRegion);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "2Progs", i + 1, 3, Class);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "2Progs", i + 1, 4, id);
			i++;
