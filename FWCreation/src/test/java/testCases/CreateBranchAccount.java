...
import payLoad.payLoad_BranchAccCreation;
...
public class CreateBranchAccount extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(CreateBranchAccount.class.getName());
	...
	public void TestCreateBranchAccount(String QueueName,String ExternalId,String City) throws Exception {
		
		//loginPO lo=new loginPO(driver);
		String val = "OAuth ";
		String StudentCreation = given().header("Authorization", val + Utils.Access_Token())
				.header("Content-Type", "application/json").body(payLoad_BranchAccCreation.BranchAccountCreation(QueueName,ExternalId,City)).when()
       ...
       // log.info("The response is: "+StudentCreation);
		...
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "BranchAccountData", i + 1, 0, QueueName);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "BranchAccountData", i + 1, 1, ExternalId);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "BranchAccountData", i + 1, 1, City);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "BranchAccountData", i + 1, 2, id);
        i++;
	}
