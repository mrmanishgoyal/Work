...
public class BulkRunAllPrograms_BTLAwithPrgmK4to10withShipped extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(BulkRunAllPrograms_BTLAwithPrgmK4to10withShipped.class.getName());
	...
	public void TestBulkRunAllPrograms_BTLAwithPrgmK4to10withShipped(String Progid,String ShippingRegion) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
			...
			StudentCreation = given().header("Authorization", val + Utils.Access_Token())
					.header("Content-Type", "application/json").body(payLoad_AllProgram.BTLAwithProgwithShipped(Progid,ShippingRegion)).when()
	       ...
	       // log.info("The response is: "+StudentCreation);
			...
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmsK4to10withShipped", i + 1, 0, Progid);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmsK4to10withShipped", i + 1, 1, ShippingRegion);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "BTLA+AllPrgmsK4to10withShipped", i + 1, 2, id);
			i++;
	...
	public Object[][] testpro() throws Exception {
		Object[][] data = readData(System.getProperty("user.dir") + "\\src\\main\\java\\testData\\TestData.xlsx",
				"BTLA+AllPrgms_K4to10withShipped");
		return data;
	}
