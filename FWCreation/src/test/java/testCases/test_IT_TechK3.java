...
public class test_IT_TechK3 extends base {

	public WebDriver driver;
	//public String CurrURL;
	public static Logger log = LogManager.getLogger(test_IT_TechK3.class.getName());
	...
	public void Test_IT_TechK3(String Prgm1,String Prgm2,String SR,String CC,String Accid,String Cntctid,String TT,String Tid,String Category,String SCategory,String IssueT,String IssueST,String IssueN,String ITIR,String FU1,String FU2,String FU3,String FU4,String FU5,String FU6,String FU7,String FU8,String FU9,String FU10) throws Exception {
		...
		if(TaskType.contains("Inbound")) {
			...
			if(!FU4.contains("NA")) {
			it.UpdatedAddress(FU4);
			}
			if(!FU5.contains("NA")) {
			it.PinCode(FU5);
			}
			if(!FU6.contains("NA")) {
			it.ReasonForRedispatch(FU6);
			}
			if(!FU7.contains("NA")) {
			it.Productcategory(FU7);
			}
			if(!FU8.contains("NA")) {
			it.Contactnumber(FU8);
			}
			if(!FU9.contains("NA")) {
			it.Approvedby(FU9);
			}
		...
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 0, Prgm1);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 1, Prgm2);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 2, SR);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 3, CC);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 4, Accid);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 5, Cntctid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 6, TT);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 7, Tid);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 8, Category);		
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 9, SCategory);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 10, IssueT);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 11, IssueST);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 12, IssueN);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 13, ITIR);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 14, FU1);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 15, FU2);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 16, FU3);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 17, FU4);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 18, FU5);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 19, FU6);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 20, FU7);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 21, FU8);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 22, FU9);
		setData("src\\main\\java\\testData\\DataCapture.xlsx", "IT_Tech-K3", i + 1, 23, FU10);
		i++;
