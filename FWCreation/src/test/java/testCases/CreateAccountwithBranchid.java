...
import payLoad.payLoad_StudentProgramCreation;
import resources.ExcelData;
import resources.Utils;
import resources.base;

public class CreateAccountwithBranchid extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(CreateAccountwithBranchid.class.getName());
	...
	public void TestCreateAccountwithBranchid(String Accountid, String Branchid) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
			...
			StudentCreation = given().header("Authorization", val + Utils.Access_Token())
					.header("Content-Type", "application/json").body(payLoad_StudentProgramCreation.StudentProgCreation(Accountid,Branchid)).when()
			...
			//setData("src\\main\\java\\testData\\DataCapture.xlsx", "AccountwithBranchid", i + 1, 0, Branchid);
			//setData("src\\main\\java\\testData\\DataCapture.xlsx", "AccountwithBranchid", i + 1, 1, id);
			//i++;
