...
public class BulkRunAllPrograms_SinglePrgm extends base {

	public static Properties prop;
	public WebDriver driver;
	public static Logger log = LogManager.getLogger(BulkRunAllPrograms_SinglePrgm.class.getName());
	...
	public void TestBulkRunAllPrograms_SinglePrgm(String val1) throws Exception {
		...
		//lo.FromMiddleUAT("https://byjusprod--byjusuat.lightning.force.com/lightning/r/Account/0010k00001AbVZ9AAN/view");
			...
			StudentCreation = given().header("Authorization", val + Utils.Access_Token())
					.header("Content-Type", "application/json").body(payLoad_AllProgram.SingleProg(val1)).when()
			...
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "SingleProgid", i + 1, 0, val1);
			setData("src\\main\\java\\testData\\DataCapture.xlsx", "SingleProgid", i + 1, 1, id);
			i++;
